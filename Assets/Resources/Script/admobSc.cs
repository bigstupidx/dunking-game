...
public class admobSc : MonoBehaviour {
	...
	public void MoreGames(){
		Application.OpenURL ("https://play.google.com/store/apps/dev?id=7325793530748458891");
	}

	public void RateGame(){
		Application.OpenURL ("https://play.google.com/store/apps/details?id=com.miraclegates.dunking.basketball.hit");
	}
	...
	public void Start()
	{
		...
		#if UNITY_ANDROID
		string appId = "ca-app-pub-4461559436728496~4882050071";
		#elif UNITY_IPHONE
		string appId = "ca-app-pub-4461559436728496~4882050071";
		#else
		...
		#elif UNITY_ANDROID
		string adUnitId = "ca-app-pub-4461559436728496/4720954890";
		#elif UNITY_IPHONE
		string adUnitId = "ca-app-pub-4461559436728496/4720954890";
		#else
		...
		string adUnitId = "unused";
		#elif UNITY_ANDROID
		string adUnitId = "ca-app-pub-4461559436728496/4662558226";
		#elif UNITY_IPHONE
		string adUnitId = "ca-app-pub-4461559436728496/4662558226";
		#else
		string adUnitId = "unexpected_platform";
		...
		string adUnitId = "unused";
		#elif UNITY_ANDROID
		string adUnitId = "ca-app-pub-4461559436728496/8218659859";
		#elif UNITY_IPHONE
		string adUnitId = "ca-app-pub-4461559436728496/8218659859";
		#else
		string adUnitId = "unexpected_platform";
